...
[Trait("Area", "Storage")]
public class DirectoryListPathsCommandTests
{
    private readonly IServiceProvider _serviceProvider;
    private readonly IStorageService _storageService;
    private readonly ILogger<DirectoryListPathsCommand> _logger;
    private readonly DirectoryListPathsCommand _command;
    ...
    public DirectoryListPathsCommandTests()
    {
        ...
        _logger = Substitute.For<ILogger<DirectoryListPathsCommand>>();
    ...
    public async Task ExecuteAsync_WithValidParameters_ReturnsPaths()
    {
        ...
        var result = JsonSerializer.Deserialize<DirectoryListPathsResult>(json);
    ...
    private class DirectoryListPathsResult
    {
