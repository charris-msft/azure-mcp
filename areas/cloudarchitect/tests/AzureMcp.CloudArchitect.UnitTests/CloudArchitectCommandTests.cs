...
namespace AzureMcp.CloudArchitect.UnitTests;

public class CloudArchitectCommandTests
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<CloudArchitectCommand> _logger;
    private readonly CommandContext _context;
    private readonly CloudArchitectCommand _command;
    private readonly Parser _parser;

    public CloudArchitectCommandTests()
    {
        var collection = new ServiceCollection();
        _serviceProvider = collection.BuildServiceProvider();

        _context = new(_serviceProvider);
        _logger = Substitute.For<ILogger<CloudArchitectCommand>>();
        _command = new(_logger);
        _parser = new(_command.GetCommand());
    }

    [Fact]
    public async Task ExecuteAsync_GeneralCodeGeneration_ReturnsCloudArchitect()
    {
    ...
    [Fact]
    public async Task ExecuteAsync_GeneralDeployment_ReturnsCloudArchitect()
    {
    ...
    [Fact]
    public async Task ExecuteAsync_AzureFunctionsCodeGeneration_ReturnsCloudArchitect()
    {
    ...
    [Fact]
    public async Task ExecuteAsync_AzureFunctionsDeployment_ReturnsCloudArchitect()
    {
    ...
    [Fact]
    public async Task ExecuteAsync_StaticWebAppAll_ReturnsCloudArchitect()
    {
