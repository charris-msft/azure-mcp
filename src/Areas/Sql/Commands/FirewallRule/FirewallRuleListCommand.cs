    ...
    : BaseSqlCommand<FirewallRuleListOptions>(logger)
{
    ...
    public override string Description =>
        ...
        firewall rules configured for the specified SQL server, including their names, 
        start and end IP addresses. Returns an array of firewall rule objects with their properties.
        Equivalent to 'az sql server firewall-rule list'.
        """;
    ...
    public override async Task<CommandResponse> ExecuteAsync(CommandContext context, ParseResult parseResult)
    {
        ...
        try
        {
            ...
            var firewallRules = await sqlService.GetFirewallRulesAsync(
                options.Server!,
    ...
    internal record FirewallRuleListResult(List<SqlFirewallRule> FirewallRules);
}